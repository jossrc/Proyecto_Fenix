...
CREATE TABLE BOLETA(
  ...
  TOT_BOL     DECIMAL(10,2) NOT NULL CHECK (TOT_BOL),
  ID_CLI      INT           NOT NULL,
...
CREATE TABLE DETALLE_BOLETA(
  NUM_BOL       INT            NOT NULL REFERENCES BOLETA(NUM_BOL),
  COD_PRO       CHAR(8)        NOT NULL REFERENCES PRODUCTO(COD_PRO),
...
CREATE TABLE VENTA(
  ...
  NUM_BOL  INT  REFERENCES BOLETA(NUM_BOL),
